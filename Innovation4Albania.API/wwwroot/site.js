...
const translations = {
    sq: {
        ...
        common: {
            ...
            loadingData: "Po ngarkohen të dhënat e platformës...",
            yes: "Po",
            no: "Jo"
        },
        nav: {
        ...
        landing: {
            platformName: "Platforma Kombëtare e Inovacionit Publik",
            kicker: "Inovacioni publik shqiptar",
            title: "Inovacioni Publik Shqiptar — i Monitoruar, i Matur, i Suksesshem",
            subtitle: "Platforma kombëtare për menaxhimin e projekteve të inovacionit në 12 ministritë e Republikës së Shqipërisë.",
            summary1Kicker: "Monitorim Kombëtar",
            summary1Title: "12 ministri ne nje pamje te vetme",
            summary1Text: "Vendimmarrje me KPI, afate, progres dhe risk në një panel të unifikuar.",
            summary2Kicker: "Punë Operative",
            summary2Title: "Workflow, dokumente dhe raportim",
            summary2Text: "Drejtori dhe ekspertët menaxhojnë projektet në mënyrë të strukturuar dhe të gjurmueshme.",
            quickKicker: "Pamje e shpejtë",
            activeMinistries: "Ministri aktive",
            roleAccess: "Akses i ndarë sipas përgjegjësisë",
            ...
            nationalPerformance: "Performanca Kombëtare",
            citizenKicker: "Pjesëmarrja qytetare",
            citizenTitle: "Vlerësoni projektet publike",
            ...
            ministriesTitle: "12 Ministri të Integruara",
            ministriesText: "Një platformë për gjithë qeverinë shqiptare",
            autoAlertsTitle: "Alerts Automatike",
            autoAlertsText: "Njoftohuni menjehere kur projektet jane ne risk",
            howItWorks: "Si funksionon",
            workflowSteps: "Rrjedha e punës në 3 hapa",
            step1: "Drejtori shton projektet dhe cakton ekspertët",
            step2: "Ekspertët përditësojnë progresin dhe ngarkojnë dokumentet",
            step3: "Ministrja monitoron performancen ne kohe reale",
            footerText: "Platforma kombëtare për menaxhimin e inovacionit publik.",
            about: "Rreth Nesh",
            privacy: "Privatesia",
            contact: "Kontakt",
        ...
        login: {
            title: "Platforma e Menaxhimit të Projekteve",
            subtitle: "Platformë e centralizuar për monitorimin e projekteve të inovacionit publik në 12 ministritë e Republikës së Shqipërisë.",
            mvpProjects: "Projekte MVP",
            demoRoles: "Rolet demo",
            demoAccess: "Hyrje demo",
            chooseRole: "Zgjidh rolin",
            demoText: "Ky MVP simulon login sipas rolit dhe hap panelin me akses të filtruar.",
            ...
            dataSourcesText: "Struktura është përgatitur që më vonë të lidhet me Google Sheets, Excel dhe API sync pa ndryshuar UI-në bazë."
        },
        publicPage: {
            ...
            updated: "Perditesuar",
            updatedText: "Të dhënat agregohen nga portofoli kombëtar dhe publikohen në mënyrë të përmbledhur.",
            ...
            nationalSummary: "Përmbledhja kombëtare",
        ...
        roles: { PrimeMinister: "Kryeministri", Minister: "Ministrja", Director: "Drejtori i Përgjithshëm", NucleusDirector: "Drejtori i Nuklit", Expert: "Eksperti" }
    },
    en: {
...
const perkthimRoleve = {
    ...
    Minister: "Ministrja",
    Director: "Drejtori i Përgjithshëm",
    NucleusDirector: "Drejtori i Nuklit",
    Expert: "Eksperti"
};
